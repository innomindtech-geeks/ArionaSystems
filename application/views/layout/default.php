...
<link href="<?php echo BASE_URL;?>assets/css/jquery.nouislider.css" rel="stylesheet">
<!---------------------- Google Font ----------------->
<link href='http://fonts.googleapis.com/css?family=Lato:400,700,400italic' rel='stylesheet' type='text/css'>
<!---------------------- Font awesome ----------------->
<link href="<?php echo BASE_URL;?>assets/css/sonnet.css" rel="stylesheet">
<!--[if lt IE 8]><!-->
	<link rel="stylesheet" href="<?php echo BASE_URL;?>assets/css/sonnet-ie7.css">
<!--<![endif]-->
...
<!---------------------- Easy dropdown ------------->
<link rel="stylesheet" href="<?php echo BASE_URL;?>assets/css/easydropdown.css">

<!---------------------- Tooltip ------------->
<link rel="stylesheet" href="<?php echo BASE_URL;?>assets/css/jquery.smallipop.css">
...
<script src="<?php echo BASE_URL;?>assets/js/jquery.easydropdown.min.js"></script>
<script src="<?php echo BASE_URL;?>assets/js/jquery.smallipop.js"></script>
<script src="<?php echo BASE_URL;?>assets/js/jquery.fancybox.js"></script>
<script src="<?php echo BASE_URL;?>assets/js/jquery.slicknav.js"></script>
 
<script src="<?php echo BASE_URL;?>assets/js/resize.js"></script>
